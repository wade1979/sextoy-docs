...
const documents = [
  ...
  {title: 'Create Companion', path: 'guide/ai-companion/index.html'},
  {title: 'Device Control Modes', path: 'guide/modes-overview/index.html'},
  {title: 'AI Companion', path: 'guide/modes/ai-companion/index.html'},
  {title: 'Free Control', path: 'guide/modes/free-control/index.html'},
  {title: 'Video Sync', path: 'guide/modes/video-sync/index.html'},
  {title: 'Live Sync', path: 'guide/modes/live-sync/index.html'},
